...
const CATEGORIES = [
    // Faculties
    { id: 1, name: 'Architecture', name_zh: '建筑学院', type: 'faculty' },
    { id: 2, name: 'Arts', name_zh: '文学院', type: 'faculty' },
    { id: 3, name: 'Business & Economics', name_zh: '商学院', type: 'faculty' },
    { id: 4, name: 'Dentistry', name_zh: '牙医学院', type: 'faculty' },
    { id: 5, name: 'Education', name_zh: '教育学院', type: 'faculty' },
    { id: 6, name: 'Engineering', name_zh: '工程学院', type: 'faculty' },
    { id: 7, name: 'Law', name_zh: '法学院', type: 'faculty' },
    { id: 8, name: 'Medicine', name_zh: '李嘉诚医学院', type: 'faculty' },
    { id: 9, name: 'Science', name_zh: '理学院', type: 'faculty' },
    { id: 10, name: 'Social Sciences', name_zh: '社会科学学院', type: 'faculty' },
    // Main Campus
    { id: 101, name: 'Main Building', name_zh: '主楼', type: 'building' },
    { id: 102, name: 'Haking Wong Building', name_zh: '王克桢楼', type: 'building' },
    { id: 103, name: 'Chow Yei Ching Building', name_zh: '周亦卿楼', type: 'building' },
    { id: 104, name: 'K.K. Leung Building', name_zh: '梁銶琚楼', type: 'building' },
    { id: 105, name: 'Meng Wah Complex', name_zh: '蒙民伟楼', type: 'building' },
    { id: 106, name: 'Chong Yuet Ming Buildings', name_zh: '庄月明楼', type: 'building' },
    { id: 107, name: 'Hui Oi Chow Science Building', name_zh: '许爱周科学楼', type: 'building' },
    { id: 108, name: 'James Hsioung Lee Science Building', name_zh: '李兆基科学楼', type: 'building' },
    { id: 109, name: 'Kadoorie Biological Sciences Building', name_zh: '嘉道理生物科学楼', type: 'building' },
    { id: 110, name: 'Knowles Building', name_zh: '诺尔斯楼', type: 'building' },
    { id: 111, name: 'Pao Siu Loong Building', name_zh: '包兆龙楼', type: 'building' },
    { id: 112, name: 'Hung Hing Ying Building', name_zh: '孔庆荧楼', type: 'building' },
    { id: 113, name: 'Tang Chi Ngong Building', name_zh: '邓志昂楼', type: 'building' },
    { id: 114, name: 'Fung Ping Shan Building', name_zh: '冯平山楼', type: 'building' },
    { id: 115, name: 'T.T. Tsui Building', name_zh: '徐展堂楼', type: 'building' },
    { id: 116, name: 'Rayson Huang Theatre', name_zh: '黄丽松讲堂', type: 'building' },
    { id: 117, name: 'Tam Wing Fan Innovation Wing', name_zh: '谭荣芬创新翼', type: 'building' },
    // Centennial Campus
    { id: 201, name: 'Cheng Yu Tung Tower', name_zh: '郑裕彤楼', type: 'building' },
    { id: 202, name: 'Chi Wah Learning Commons', name_zh: '智华学习共享空间', type: 'building' },
    { id: 203, name: 'Lee Shau Kee Lecture Centre', name_zh: '李兆基演讲厅', type: 'building' },
    { id: 204, name: 'The Grand Hall', name_zh: '大会堂', type: 'building' },
    { id: 205, name: 'Run Run Shaw Tower', name_zh: '邵逸夫楼', type: 'building' },
    { id: 206, name: 'The Jockey Club Tower', name_zh: '赛马会楼', type: 'building' },
    { id: 207, name: 'Lui Che Woo Law Library', name_zh: '吕志和法律图书馆', type: 'building' },
    { id: 208, name: 'Run Run Shaw Heritage House', name_zh: '邵逸夫文物馆', type: 'building' },
    // Halls
    { id: 301, name: 'Eliot Hall', name_zh: '伊利沙伯堂', type: 'hall' },
    { id: 302, name: 'May Hall', name_zh: '梅堂', type: 'hall' },
    { id: 303, name: 'Swire Hall', name_zh: '施德堂', type: 'hall' },
    { id: 304, name: 'Simon K. Y. Lee Hall', name_zh: '李国贤堂', type: 'hall' },
    { id: 305, name: 'Graduate House', name_zh: '研究生宿舍', type: 'hall' },
    { id: 306, name: 'Robert Black College', name_zh: '黑池学院', type: 'hall' },
    { id: 307, name: 'Jockey Club Student Village I', name_zh: '赛马会学生村一期', type: 'hall' },
    { id: 308, name: 'Jockey Club Student Village II', name_zh: '赛马会学生村二期', type: 'hall' },
    { id: 309, name: 'Jockey Club Student Village III', name_zh: '赛马会学生村三期', type: 'hall' },
    { id: 310, name: 'Jockey Club Student Village IV', name_zh: '赛马会学生村四期', type: 'hall' },
    { id: 311, name: "St. John's College", name_zh: '圣约翰学院', type: 'hall' },
    { id: 312, name: 'Ricci Hall', name_zh: '利玛窦堂', type: 'hall' },
    { id: 313, name: 'University Hall', name_zh: '大学堂', type: 'hall' },
    { id: 314, name: 'Mui Fong House', name_zh: '梅芳居', type: 'hall' },
    // Medical
